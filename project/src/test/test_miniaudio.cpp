...
namespace miniaudio_test
{
	...
	r2tm::DoFunctionT Engine_Volume::GetDoFunction() const
	{
		return []()->r2tm::eDoLeaveAction
		{
			...
			{
				PROCESS_MAIN( result = ma_sound_init_from_file( &engine, "resources/bgm/Joth_8bit_Bossa.mp3", 0, NULL, NULL, &sound ) );
				EXPECT_EQ( MA_SUCCESS, result );
	...
	r2tm::DoFunctionT Engine_PlaySound::GetDoFunction() const
	{
		return []()->r2tm::eDoLeaveAction
		{
...

			{
				...
				PROCESS_MAIN( result = ma_engine_play_sound( &engine, "resources/bgm/Joth_8bit_Bossa.mp3", nullptr ) );
				EXPECT_EQ( MA_SUCCESS, result );
			}
	...
	r2tm::DoFunctionT Engine_Time::GetDoFunction() const
	{
		return []()->r2tm::eDoLeaveAction
		{
			...
			{
				EXPECT_EQ( MA_SUCCESS, ma_sound_init_from_file( &engine, "resources/bgm/Joth_8bit_Bossa.mp3", 0, NULL, NULL, &sound ) );
	...
	r2tm::DoFunctionT Sound_Init_Load::GetDoFunction() const
	{
		return []()->r2tm::eDoLeaveAction
		{
...

			{
				...
				PROCESS_MAIN( result = ma_sound_init_from_file( &engine, "resources/sfx/test_sfx_01.wav", 0, NULL, NULL, &sound ) );
				EXPECT_EQ( MA_SUCCESS, result );
			}
	...
	r2tm::DoFunctionT Sound_Duplicate::GetDoFunction() const
	{
		return []()->r2tm::eDoLeaveAction
		{
...

			{
				...
				PROCESS_MAIN( result = ma_sound_init_from_file( &engine, "resources/bgm/Joth_8bit_Bossa.mp3", 0, NULL, NULL, &sound_orig ) );
				EXPECT_EQ( MA_SUCCESS, result );
			}
	...
	r2tm::DoFunctionT Group_Volume::GetDoFunction() const
	{
		return []()->r2tm::eDoLeaveAction
		{
...

			{
				...
				EXPECT_EQ( MA_SUCCESS, ma_sound_init_from_file( &engine, "resources/bgm/Joth_8bit_Bossa.mp3", 0, &sound_group, NULL, &sound_1 ) );
				...
				EXPECT_EQ( MA_SUCCESS, ma_sound_init_from_file( &engine, "resources/bgm/TinyWorlds_Forest_Ambience.mp3", 0, &sound_group, NULL, &sound_2 ) );
